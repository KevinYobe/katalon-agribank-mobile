...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - 5, Amount</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = '5, Amount' or . = '5, Amount') and @resource-id = '']</locator>
