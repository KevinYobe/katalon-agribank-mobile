...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - Ref, Reference</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Ref, Reference' or . = 'Ref, Reference') and @resource-id = '']</locator>
