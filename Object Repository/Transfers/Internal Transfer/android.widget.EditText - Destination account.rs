...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - Destination account</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Destination account' or . = 'Destination account') and @resource-id = '']</locator>
