...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - Beneficiary name</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Beneficiary name' or . = 'Beneficiary name') and @resource-id = '']</locator>
