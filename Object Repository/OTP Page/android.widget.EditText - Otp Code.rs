...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - Otp Code</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Otp Code' or . = 'Otp Code') and @resource-id = '']</locator>
