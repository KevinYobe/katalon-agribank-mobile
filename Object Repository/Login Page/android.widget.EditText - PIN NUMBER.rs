...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - PIN NUMBER</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'PIN NUMBER' or . = 'PIN NUMBER') and @resource-id = '']</locator>
