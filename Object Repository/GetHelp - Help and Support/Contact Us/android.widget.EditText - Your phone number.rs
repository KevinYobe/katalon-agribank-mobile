...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - Your phone number</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Your phone number' or . = 'Your phone number') and @resource-id = '']</locator>
