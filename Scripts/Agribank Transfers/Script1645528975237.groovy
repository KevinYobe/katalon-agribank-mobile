...
Mobile.scrollToText('Select destination bank', FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Object Repository/Transfers/ZIPIT Transfer/android.widget.Button Select destination bank'), 5)

Mobile.tap(findTestObject('Object Repository/Transfers/ZIPIT Transfer/Select Bank/android.view.View FBC Bank'), 5)
